...
public class DFS {
    ...
    boolean solveMaze(int maze[][]) {
        if (mazeDFS(maze, m.xstart, m.ystart, m.jalurs) == false) {
    ...
    /* A recursive utility function to solve Maze
     problem */
    boolean mazeDFS(int maze[][], int x, int y,
            int sol[][]) {
    ...
    void cariSimpul(int x, int y) {
        ...
        xubah = Integer.parseInt(koor[0]);
        yubah = Integer.parseInt(koor[1]);
        System.out.println("Simpul ke- "+ simpul++ +" : (" + xubah + "," + yubah+")");
//                visit=true;
    }
